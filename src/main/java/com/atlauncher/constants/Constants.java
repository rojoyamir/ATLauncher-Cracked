...
public class Constants {
    ...
    public static final String FABRIC_META_API_URL = "https://meta.fabricmc.net";
    ...
    public static final String LEGACY_FABRIC_META_API_URL = "https://meta.legacyfabric.net";
    ...
    public static final String QUILT_META_API_URL = "https://meta.quiltmc.org";
