...
public class GeneralSettingsTab extends AbstractSettingsTab {
    ...
    protected void onShow() {
        ...
        JButton createShortcutButton = new JButton(GetText.tr("Create Desktop Shortcut"));
        createShortcutButton.addActionListener(e -> {
            if (com.atlauncher.utils.ShortcutManager.createDesktopShortcut()) {
                DialogManager.okDialog()
                    .setTitle(GetText.tr("Desktop Shortcut"))
                    .setContent(GetText.tr("Desktop shortcut has been created."))
                    .show();
            } else {
                DialogManager.okDialog()
